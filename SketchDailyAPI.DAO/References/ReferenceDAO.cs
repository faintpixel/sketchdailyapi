...
namespace SketchDailyAPI.DAO.References
{
        ...
        where TClassifications : BaseClassifications
    {
        ...
        public ReferenceDAO(ReferenceType type, IQueryable<TReference, TClassifications> queryable, AppSettings appSettings)
        {
            ...
            _logger = new Logger("ReferenceDAO", appSettings);
